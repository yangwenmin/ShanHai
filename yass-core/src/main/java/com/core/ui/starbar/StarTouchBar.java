 ...
 *
 */
public class StarTouchBar extends View {
    ...
    public StarTouchBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public StarTouchBar(Context context, AttributeSet attrs, int defStyleAttr) {
